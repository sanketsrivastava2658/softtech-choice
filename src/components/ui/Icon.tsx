...
/**
 * Single inline-SVG icon set (Feather-style, 1.8 stroke). Keeps the bundle free
 * of an icon dependency and lets every glyph inherit `currentColor`.
 */
...
const P: Record<IconName, React.ReactNode> = {
  ...
  filter: <path d="M4 4h16M7 12h10M10 20h4" />,
